    ...
    <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            $sql = "SELECT r.reservation_id, r.customer_id, r.gown_id, r.start_date, r.end_date, r.total_price, r.status, g.name, g.main_image, a.reservation_id, a.date_signed 
            FROM reservations r JOIN gowns g ON r.gown_id = g.gown_id  JOIN agreements a ON r.reservation_id = a.reservation_id WHERE r.customer_id = '$user_id' AND r.status = 'confirmed'";
