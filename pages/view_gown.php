        ...
        <div class="col-lg-12">
                    ...
                    if (isset($_GET['gown_id']) && is_numeric($_GET['gown_id'])) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <div class="card-body">
                                <div class="row">
                                <div class="col-xl-3 col-lg-6 col-md-6 col-xxl-5 align-items-center">
    <!-- Tab panes -->
    <div class="tab-content">
    <div role="tabpanel" class="tab-pane fade show active" id="first">
        <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['main_image'])); ?>" alt="" style="width: 100%; height: 350px; object-fit: cover;">
    </div>
    <div role="tabpanel" class="tab-pane fade" id="second">
        <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img1'])); ?>" alt="" style="width: 100%; height: 350px; object-fit: cover;">
    </div>
    <div role="tabpanel" class="tab-pane fade" id="third">
        <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img2'])); ?>" alt="" style="width: 100%; height: 350px; object-fit: cover;">
    </div>
    <div role="tabpanel" class="tab-pane fade" id="for">
        <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img3'])); ?>" alt="" style="width: 100%; height: 350px; object-fit: cover;">
    </div>
</div>

<div class="tab-slide-content new-arrival-product mb-4 mb-xl-0 d-flex justify-content-center">
    <!-- Nav tabs -->
    <ul class="nav slide-item-list mt-3" role="tablist">
        <li role="presentation" id="tab-first">
            <a href="#first" role="tab" data-bs-toggle="tab" onclick="activateTab(event, 'first')">
                <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['main_image'])); ?>" alt="" width="50" style="height: 50px; object-fit: cover;">
            </a>
        </li>
        <li role="presentation" id="tab-second" class="disabled">
            <a href="#second" role="tab" data-bs-toggle="tab" onclick="activateTab(event, 'second')" style="pointer-events: none;">
                <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img1'])); ?>" alt="" width="50" style="height: 50px; object-fit: cover;">
            </a>
        </li>
        <li role="presentation" id="tab-third" class="disabled">
            <a href="#third" role="tab" data-bs-toggle="tab" onclick="activateTab(event, 'third')" style="pointer-events: none;">
                <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img2'])); ?>" alt="" width="50" style="height: 50px; object-fit: cover;">
            </a>
        </li>
        <li role="presentation" id="tab-for" class="disabled">
            <a href="#for" role="tab" data-bs-toggle="tab" onclick="activateTab(event, 'for')" style="pointer-events: none;">
                <img class="img-fluid" src="<?php echo htmlspecialchars(str_replace('../', '', $row['img3'])); ?>" alt="" width="50" style="height: 50px; object-fit: cover;">
            </a>
        </li>
    </ul>
</div>
            ...
            <div class="product-detail-content">
                ...
                <div class="new-arrival-content pr">
                    ...
                    <div class="d-table mb-2">
                        <p class="price float-start d-block"><?php echo htmlspecialchars($row['price']); ?> PHP</p>
                    </div>
                    <p>Availability: <span class="item"><?php echo htmlspecialchars($row['availability_status']); ?><i class="fa fa-shopping-basket"></i></span></p>
                    <p class = "text-warning">Size: <span class="item"><?php echo htmlspecialchars($row['size']); ?></span></p>
                        ...
                        <div class="size-filter">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                ...
                                foreach ($sizes as $size) {
                                    ...
                                    echo '<label class="btn btn-outline-primary" for="btnradio' . $size . '">' . $size . '</label>';
                                }
                                ?>
                            </div>
                        </div>
...
<script>
    function activateTab(event, tabId) {
        ...
        // Check if the first tab is being clicked
        if (tabId === 'first') {
            // Enable the other tabs
            document.getElementById('tab-second').classList.remove('disabled');
            document.getElementById('tab-third').classList.remove('disabled');
            document.getElementById('tab-for').classList.remove('disabled');

            // Make them clickable
            document.querySelector('#tab-second a').style.pointerEvents = 'auto';
            document.querySelector('#tab-third a').style.pointerEvents = 'auto';
            document.querySelector('#tab-for a').style.pointerEvents = 'auto';
        }
