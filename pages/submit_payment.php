            ...
            <div class="card-body px-4 pt-4 pb-4">
                <div class="row">
                                    ...
                                    <div class="col-lg-8 order-lg-1">
                                        <form class="needs-validation" novalidate="" method = "POST" action = "process/add_payment.php" enctype = "multipart/form-data">
                                    ...
                                    <small class="text-muted">Please leave empty the Gcash Fields if you choose Cash on Pick Up payment method</small>
                                            ...
                                            <div class="d-block my-3">
                                              ...
                                              <div class="form-check custom-radio mb-2">
                                                  <input id="debit" name="paymentMethod" type="radio" class="form-check-input" value="Gcash" required="">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="gcash_name" name = "gcash_name" placeholder="" required="">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="gcash_number" name = "gcash_number"placeholder="" required="">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name = "transaction_id" class="form-control" id="cc-expiration" placeholder="" required="">
                                                    <div class="invalid-feedback">
