  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Pepping's Boutique</span>
      </a>
    </div>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="row">
        <div class="col-12">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                ...
                                <p class="text-xs text-secondary mb-0"><?php echo htmlspecialchars($color); ?></p>
                            </div>
                        </div>
                    </td>
                    <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo htmlspecialchars($price); ?></p>
                        <p class="text-xs text-secondary mb-0">PHP</p> 
                    </td>
                    <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo htmlspecialchars($availability_status); ?></span>
                    </td>
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo htmlspecialchars($created_at); ?></span>
                    </td>
                    <td class="align-middle">
                        <a class="btn btn-warning btn-md" href="edit_gown.php?gown_id=<?php echo $row['gown_id']; ?>"><i class="fas fa-edit"></i></a>
                        <a class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" onclick="setPropertyId('<?php echo $gown_id; ?>')">
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='5'>No gowns found</td></tr>";
                    }
          ...
          <br>
          <a href = "add_gown.php" class = "btn btn-primary"><i class = "fa fa-plus"></i> Add Gown</a>
        </div>
        <script>
